...
type AuditHistoryViewType struct {
	...
	AuditHistoryViewFields []AuditHistoryView  `json:"results"`
	Total int `json:"total"`
}
type AuditHistoryView struct {
		AuditHistoryID int    `json:"audit_history_id"`
		TypeChanges    int    `json:"type_changes"`
		TypeChangesStr string `json:"type_changes_str"`
		KeyCall        int    `json:"key_call"`
